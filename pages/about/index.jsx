...
export default function About() {
  return (
    <Fragment>
      <Head>
        <title>About | Horizontal Architect Agency</title>
        ...
        />
        <link rel="canonical" href="https://addwebsite.com/about" />
        <link
          rel="alternate"
          hreflang="en-US"
        ...
        <meta
          property="og:title"
          content="About | Horizontal Architect Agency"
        />
        <meta
          property="og:description"
          content="The React Framework for the Web"
        />
        <meta property="og:url" content="https://addwebsite.org/about" />
